<template>
    <label class="block mb-6 p-7 border rounded-md cursor-pointer"
        :class="{ 
            'border-[#097CCD] bg-[#EBF4FF]': currentValue,
            'bg-[#F6F6F6] border-[#CCCCCC]': !currentValue
        }"
    >
        <span :class="radioClasses">
            <span :class="innerClasses" class="mr-9"></span>
            <input
                type="radio"
                :class="inputClasses"
